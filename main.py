    """
    Rate Limiter Ynlck0z
    ====================
    Open-source API service that validates data between clients and backends.
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Open-source API service that validates data between clients and backends.")
